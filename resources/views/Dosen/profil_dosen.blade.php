        ...
        <div class="card-body box-profile">
          <div class="text-center">
            ...
            <img class="profile-user-img img-fluid"
              ...
              src="{{ asset('storage/foto_profil_dosen/' . $dosen->foto_profil) }}" alt="User profile picture">
            @else
      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
          ...
          <p class="text-muted" style="margin-top: 5px;">
            <?php
                if ($ijazah && $ijazah->isNotEmpty()) {
                    $Institusi = $ijazah->pluck('institusi')->unique();
                    echo implode(', ', $Institusi->toArray());
                } else {
                    echo 'Data lulusan tidak tersedia.';
                }
            ?>
          </p>
          <hr>

          <strong><i class="fas fa-pencil-alt mr-1"></i> Bidang Keahlian</strong>
          <p class="text-muted" style="margin-top: 5px;">
            <?php
                if ($serkom && $serkom->isNotEmpty()) {
                    $Keahlian = $serkom->pluck('bidang')->unique();
                    echo implode(', ', $Keahlian->toArray());
                } else {
                    echo 'Data Bidang Keahlian tidak tersedia.';
                }
            ?>
          </p>
          <hr>
          ...
          <p class="text-muted" style="margin-top: 5px;">
            <?php
               if ($jabatan && $jabatan->isNotEmpty()) {
                $Nama_jabatan= $jabatan->pluck('nama_jabatan')->unique();
                echo implode(', ', $Nama_jabatan->toArray());
            } else {
                echo 'Data Jabatan tidak tersedia.';
            }
            ?>
          </p>
        </div>
      ...
      <div class="card">
        <div class="card-header ">
          <ul class="nav nav-pills">
            <li class="nav-item">
              <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#editdata">Edit Profil</button>
            </li>
          </ul>
        </div>
            ...
            <div class="active tab-pane">
              <form class="form-horizontal">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="nidn" placeholder="NIDN" value="{{ $dosen->nidn }}"
                      disabled>
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  <label for="serdos" class="col-sm-2 col-form-label">Serdos</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="serdos" placeholder="Nomer Sertifikat Dosen"
                      value="{{ $dosen->serdos }}" disabled>
                  </div>
                </div>
                <div class="form-group row">
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-horizontal" method="POST" action="{{ route('update_profil', ['user' => $user->id]) }}">
              @csrf
              <input type="hidden" name="user_id" value="{{ $user->id }}">
              <div class="form-group row">
                <label for="NIDN" class="col-sm-2 col-form-label">NIDN</label>
              ...
              <div class="form-group row">
                <label for="serdos" class="col-sm-2 col-form-label">Serdos</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="serdos" id="serdos" placeholder="Nomer Sertifikat Dosen"
                    value="{{ $dosen->serdos }}">
                </div>
              </div>
              <div class="form-group row">
    ...
    <div class="modal fade" id="editfoto" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-horizontal" method="POST" action="{{ route('update_foto') }}"
              ...
              <div class="form-group row" style="margin-bottom:5px;">
                ...
                <div class="col-sm-10">
                  @if($dosen->foto_profil)
                  <img src="{{ asset('storage/foto_profil_dosen/' . $dosen->foto_profil) }}" alt="Foto Profil"
                  ...
                  @endif
                  <input type="file" class="form-control" style="margin-bottom:15px; margin-top: 20px;" name="foto_profil"
                    id="foto_profil">
