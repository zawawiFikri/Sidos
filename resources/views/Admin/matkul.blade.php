...
<div class="container">
    ...
    <div class="card-header" style="max-height: 35px; padding-top: 5px;">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{ route('show-mata', ['id' => $dataDosen->id]) }}"
        ...
        <div class="card">
          <div class="card-header ">
            <ul class="nav nav-pills">
              <li class="nav-item">
                <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#tambah_matkul">+ Tambah
                  File</button>
              </li>
            </ul>
          </div>
            ...
            <div class="tab-content">
              <table class="table table-bordered align-middle" id="tabel-dosen">
                <thead class="table-light">
                  <tr>
                    <th scope="col" style="width: 8%; font-size: 12px;" class="text-center">No.Matkul</th>
                    <th scope="col" style="width: 8%; font-size: 12px;" class="text-center">Mata Kuliah</th>
                ...
                <tbody class="table-group-divider">
                  @foreach ($dataMata as $data)
                  <tr>
                    <td class="text-center">{{ $data->id}}</td>
                    <td class="text-center">{{ $data->matkul}}</td>
                    ...
                    <td class="text-center d-flex justify-content-center">
                      <div class="row mt-2">
                        <div class="col">
                          <a href="{{ route('show-mataa', ['id' => $data->id]) }}"
                            class="btn btn-primary btn-sm">Detail</a>
                        </div>
                        <div class="col">
                          <form action="{{route('delete_mata', ['id' => $data->id])}}" method="post">
                            @csrf
  ...
  <div class="modal fade" id="tambah_matkul" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-horizontal" action="{{ route('create_mata', ['id' => $dataDosen->id]) }}" method="post"
            enctype="multipart/form-data">
            @csrf
            <div class="form-group row">
              <label for="Matkul" class="col-sm-2 col-form-label">Nama Matkul</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="matkul" id="matkul" placeholder="Nama Matkul" required>
              </div>
            </div>
            <div class="form-group row">
              <label for="sks" class="col-sm-2 col-form-label">SKS</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="sks" id="sks" placeholder="Jumlah SKS" required>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="thn_ajar" id="thn_ajar" placeholder="Tahun Ajar" required>
              </div>
            </div>
