...
<div class="container">
    ...
    <div class="card-header" style="max-height: 35px; padding-top: 5px;">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{ route('show-ijasah', ['id' => $dataDosen->id]) }}"
        ...
        <div class="card">
          <div class="card-header ">
            <ul class="nav nav-pills">
              <li class="nav-item">
                <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#tambah_ijasah">+ Tambah
                  File</button>
              </li>
            </ul>
          </div>
          <div class="card-body" style="padding-top: 5px;">
            <div class="tab-content">
              <table class="table table-bordered align-middle" id="tabel-ijasah">
                <thead class="table-light">
                  <tr>
                    <th scope="col" style="width: 8%; font-size: 12px;" class="text-center">No.Ijazah</th>
                    <th scope="col" style="width: 8%; font-size: 12px;" class="text-center">Lulusan</th>
                ...
                <tbody class="table-group-divider">
                  ...
                  <tr>
                    ...
                    <td class="text-center">{{ $data->program_study}}</td>
                    ...
                    <td class="text-center d-flex justify-content-center">
                      <div class="row mt-2">
                        <div class="col">
                          <a href="{{ route('show-ijasahh', ['id' => $data->id]) }}"
                            class="btn btn-primary btn-sm">Detail</a>
                        </div>
                        <div class="col">
                          <form action="{{route('delete_ijasah', ['id' => $data->id])}}" method="post">
                            @csrf
  ...
  <div class="modal fade" id="tambah_ijasah" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-horizontal" action="{{ route('create_ijasah', ['id' => $dataDosen->id]) }}" method="post"
            enctype="multipart/form-data">
            @csrf
            <div class="form-group row">
              <label for="No_ijazah" class="col-sm-2 col-form-label">No. Ijazah</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="id" id="id" placeholder="Nomer Ijazah" required>
              </div>
            </div>
            <div class="form-group row">
              <label for="institusi" class="col-sm-2 col-form-label">Nama Institusi</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="institusi" id="institusi" placeholder="Nama Institusi"
                  required>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="gelar" id="gelar" placeholder="Nama Gelar" required>
              </div>
            </div>
            <div class="form-group row">
